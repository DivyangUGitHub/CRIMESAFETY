    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Report not found</p>
          <Link href="/reports">
            <button className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-lg text-white mt-4">Back to Reports</button>
          </Link>
        </div>
      </div>
    );
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-start gap-2"><span className="text-red-400">•</span> Stay alert and aware of your surroundings</li>
                <li className="flex items-start gap-2"><span className="text-red-400">•</span> Keep valuables out of sight in vehicles</li>
                <li className="flex items-start gap-2"><span className="text-red-400">•</span> Park in well-lit, busy areas</li>
                <li className="flex items-start gap-2"><span className="text-red-400">•</span> Trust your instincts - if something feels wrong, leave</li>
                <li className="flex items-start gap-2"><span className="text-red-400">•</span> Report suspicious activity immediately</li>
              </ul>
            </motion.div>
          </div>
        </div>
